# Sanity-gatsby-portfolio-latest
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/k5gt3qdy/settings/api) and create a token with read rights.
